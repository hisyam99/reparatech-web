// File: /frontend/src/components/home/Section2.tsx
        ...
        {[
          {
            ...
            description:
              'Layanan perbaikan cepat untuk kerusakan ringan dengan teknisi profesional dan garansi penuh.',
            features: [
              'Diagnosa gratis',
              'Sparepart original',
              'Garansi 90 hari',
          ...
          },
          {
            ...
            description:
              'Jaminan kualitas dengan garansi layanan hingga 90 hari dan garansi uang kembali.',
          ...
          },
          {
            ...
            description:
              'Tim teknisi berpengalaman dengan sertifikasi resmi dari berbagai brand ternama.',
            features: [
              'Bersertifikasi',
              '5 Tahun pengalaman',
              'Training Berkala',
          ...
          <div
            key={index}
            className="bg-base-100 rounded-lg shadow-md p-5 max-w-[300px] flex items-center">
            <div className="w-6 h-6 mr-4 flex-shrink-0 relative">
              <Image
                src={card.icon}
                alt={`Icon ${index + 1}`}
                layout="fill"
